...
<header>
    ...
    <div class="header">
        ...
        <span class="headerBouton">
            <a href="<?= PROJECT_FOLDER ?>chat.php" <?php if ($page == "chat.php") : ?>style="color: orange;" <?php endif; ?>class="headerLink">CHAT</a>
        </span>
        <span class="headerBouton">
        ...
        <?php else : ?>
            <span class="headerProfile">
                ...
                <a href="<?= PROJECT_FOLDER ?>myAccount.php" <?php if ($page == "myAccount.php") : ?>style="color: orange;" <?php endif; ?> class="headerPseudo"><?php echo obtenirPseudo($pdo, $_SESSION['userId']) ?></a>
            </span>
        <?php endif; ?>
    </div>
</header>